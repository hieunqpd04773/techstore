...
include_once('view/admin_0/header.php');
switch ($action) {
		case 'default':
		include('view/admin_0/default.php');
		break;
///////////	het default	///////////////////
case 'list_products':
		$categorys =  CategoryDB::get_categories();
		$products = ProductDB::get_product();
		include('view/admin_0/list_pro.php');
		break;
case 'edit_product':
		...
		include('view/admin_0/edit_pro.php');
		break;
case 'update_product':
...
case 'add_product':
		$category =  CategoryDB::get_categories();
		include('view/admin_0/add_pro.php');
		break;
case 'save_product':
		$productID = "";
		$pro_name = filter_input(INPUT_POST,'pro_name');
...
case 'list_category':
		...
		include('view/admin_0/list_cate.php');
		break;
case 'edit_category':
		$ID = filter_input(INPUT_GET, 'ID');
		$category =  CategoryDB::getCategoryById ($ID);

		include('view/admin_0/edit_cate.php');
		break;
...
case 'delete_category':
		...
		break;
case 'add_category':
		include('view/admin_0/add_cate.php');
		break;
case 'save_category':
		$categoryID = "";
		$categoryname = filter_input(INPUT_POST, 'categoryname');
...
//////////////// start user /////////////////
case 'add_user':
	include('view/admin_0/add_user.php');
	break;
case 'save_user':
	$userID="";
	...
	include('view/admin_0/list_users.php');
	break;
case 'list_users':
	$users= userDB::getusers();
	include('view/admin_0/list_users.php');
...
case 'edit_user':
	...
	include('view/admin_0/edit_user.php');
	break;
case 'update_user':
...
case 'list_orders':
	...
	include('view/admin_0/list_orders.php');
	break;
case 'wait_orders':
	$orders= OrdersDB:: get_orders_waiting();
	include('view/admin_0/list_orders_confirm.php');
	break;
case 'confirm_order':
	$ID= filter_input(INPUT_GET,'ID');
...
case 'detail_order':
	...
	include('view/admin_0/detail_order.php');
	break;
case 'delete_order':
	$ID=filter_input(INPUT_GET,'ID');
...
case 'edit_order':
	$ID=filter_input(INPUT_GET,'ID');
	$order=OrdersDB::get_orderByID ($ID);
	include('view/admin_0/edit_order.php');
	break;
case 'update_order':
	...
	$count_result=OrdersDB::updateOrder($order_ID,$order_address,$order_note,$order_date,$order_status);
	if ($count_result==1) {
		echo "<p> $count_result rows was Update with ID: $order_ID </p>";
	}
	else {
		echo "error";
	}
...
/////////////	hết receipt	//////////////////////
		...
		include_once('view/admin_0/footer.php');
