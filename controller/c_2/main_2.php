...
include_once('view/admin_2/header.php');
switch ($action) {
		case 'default':
		include('view/admin_2/default.php');
		break;
///////////	het default	///////////////////
case 'list_products':
		$categorys =  CategoryDB::get_categories();
		$products = ProductDB::get_product();
		include('view/admin_2/list_pro.php');
		break;
case 'edit_product':
		...
		include('view/admin_2/edit_pro.php');
		break;
case 'update_product':
...
case 'add_product':
		$category =  CategoryDB::get_categories();
		include('view/admin_2/add_pro.php');
		break;
case 'save_product':
		$productID = "";
		$pro_name = filter_input(INPUT_POST,'pro_name');
...
case 'list_category':
		...
		include('view/admin_2/list_cate.php');
		break;
case 'edit_category':
		$ID = filter_input(INPUT_GET, 'ID');
		$category =  CategoryDB::getCategoryById ($ID);

		include('view/admin_2/edit_cate.php');
		break;
...
case 'delete_category':
		...
		break;
case 'add_category':
		include('view/admin_2/add_cate.php');
		break;
case 'save_category':
		$categoryID = "";
		$categoryname = filter_input(INPUT_POST, 'categoryname');
...
//////////////// start user /////////////////
case 'add_user':
	include('view/admin_2/add_user.php');
	break;
case 'save_user':
	$userID="";
	...
	include('view/admin_2/list_users.php');
	break;
case 'list_users':
	$users= userDB::getusers();
	include('view/admin_2/list_users.php');
...
case 'edit_user':
	...
	include('view/admin_2/edit_user.php');
	break;
case 'update_user':
...
case 'list_orders':
	...
	include('view/admin_2/list_orders.php');
	break;
case 'wait_orders':
	$orders= OrdersDB:: get_orders_waiting();
	include('view/admin_2/list_orders_confirm.php');
	break;
case 'confirm_order':
	$ID= filter_input(INPUT_GET,'ID');
...
case 'detail_order':
	...
	include('view/admin_2/detail_order.php');
	break;
case 'delete_order':
	$ID=filter_input(INPUT_GET,'ID');
...
/////////////	hết receipt	//////////////////////
		...
		include_once('view/admin_2/footer.php');
