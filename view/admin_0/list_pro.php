    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href=".?role=c_0&CategoryID=<?php echo $value->CategoryID ?>&action=edit_product&ID=<?php echo $value->productID; ?>" class="btn btn-secondary btn-sm">Sửa</a>
                    <a href=".?role=c_0&action=delete_product&ID=<?php echo $value->productID; ?>" class="btn btn-secondary btn-sm">Xóa</a>
                </td>
            </tr>
            <?php endforeach?>
        </tbody>
