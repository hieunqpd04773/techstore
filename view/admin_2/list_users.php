    ...
    <table class="table">
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <a href=".?role=c_2&action=edit_user&ID=<?php echo $value->userID; ?>" class="btn btn-secondary btn-sm">Sửa</a>
                    <a href=".?role=c_2&action=delete_user&ID=<?php echo $value->userID; ?>" class="btn btn-secondary btn-sm">Xóa</a>
                </td>
            </tr>
