...
<table class="table">
        ...
        <?php foreach($categories as $key => $value): ?>
            <tr>
                ...
                <td>
                    <a href=".?role=c_0&action=edit_category&ID=<?php echo $value->CategoryID; ?>" class="btn btn-secondary btn-sm">Sửa</a>
                    <a href=".?role=c_0&action=delete_category&ID=<?php echo $value->CategoryID; ?>" class="btn btn-secondary btn-sm">Xóa</a>
                </td>
            </tr>
        <?php endforeach?>
        </tbody>
