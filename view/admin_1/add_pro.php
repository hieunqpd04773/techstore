    ...
    <form action="" method="post" enctype="multipart/form-data" name="checkForm" onsubmit="return validForm() && checkTypeOfImage();">
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                ...
                <input name="pro_name" class="form-control">
                <span id="tenSP-error"></span>
            </div>

            <div class="form-group col-sm-4">
                <label>ĐƠN GIÁ</label>
                <input name="pro_price" class="form-control">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <input name="pro_discount" class="form-control">
                <span id="giamGia-error"></span>
            </div>

            <div class="form-group col-sm-4">
                <label>HÌNH ẢNH</label>
                <input id="pro_image" name="pro_image" type="file" class="form-control" onfocusout="checkTypeOfImage()">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                ...
                <input name="pro_number" type="number" class="form-control">
                <span id="soLuong-error"></span>
            </div>

            <div class="form-group col-sm-4">
                <label>SỐ LƯỢT XEM</label>
                <input name="pro_view" readonly value="0" class="form-control">
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                <label>MÔ TẢ</label>
                <textarea name="pro_detail" class="form-control" rows="4"></textarea>
            </div>

            <div class="form-group col-sm-12">
                <button type="submit" name="action" value="save_product" class="btn btn-secondary">Thêm mới</button>
